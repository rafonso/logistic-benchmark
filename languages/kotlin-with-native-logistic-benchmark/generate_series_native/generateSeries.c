#include "rafael_logistic_benchmark_NativeDoubleArrayGenerator.h"
#include <stdlib.h>

JNIEXPORT jdoubleArray JNICALL Java_rafael_logistic_1benchmark_NativeDoubleArrayGenerator_generateSeries(JNIEnv* env,
